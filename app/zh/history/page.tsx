  ...
  return (
    <div className="min-h-screen bg-[#FFF7FA] pb-16">
      ...
      <main className="max-w-5xl mx-auto px-4 py-6">
        <h1 className="text-2xl font-extrabold text-slate-900 text-center mb-6">试穿历史</h1>
        {loading ? (
          ...
          <div className="text-center py-20">
            ...
            <p className="text-slate-500 text-sm mb-2">暂无试穿记录</p>
            <p className="text-slate-400 text-xs mb-6">立即试穿您的第一套服装</p>
            <a
              href="/tryon"
          ...
          <>
            <p className="text-sm text-slate-400 mb-4">共 {records.length} 条记录</p>
                  ...
                  <div className="flex gap-2 mb-4 h-48">
                    ...
                    <div className="w-24 flex flex-col gap-2 h-full">
                      <div className="flex-1">
                        <img src={shareRecord.person_image_url} alt="人物" className="w-full h-full object-cover rounded-lg" />
                      </div>
                      <div className="flex-1">
                        <img src={shareRecord.clothing_image_url} alt="服装" className="w-full h-full object-cover rounded-lg" />
                      </div>
                    </div>
                  </div>

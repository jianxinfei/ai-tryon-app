    ...
    const doCreateTask = async (isRetry: boolean): Promise<{ taskId: string } | { noRetry: true; error: string } | null> => {
      ...
      try {
        ...
        if (err.name === 'AbortError') {
          ...
          return { noRetry: true, error: '服务器响应慢，请稍后重试' };
        }
      ...
      <div className="min-h-screen bg-[#FFF7FA]">
        ...
        <main className="max-w-4xl mx-auto px-4 py-8 sm:py-12">
          ...
          <div className="text-center mb-8 sm:mb-10">
            ...
            <p className="mt-2 text-sm text-slate-500">上传人物照片和服装照片，AI 将为您生成试穿效果</p>
          </div>
          ...
          <div className="text-center py-12 sm:py-16">
            ...
            <h2 className="text-xl sm:text-2xl font-bold text-slate-900 mb-2">请先登录</h2>
            <p className="text-sm text-slate-500 mb-6">登录即可体验 AI 虚拟试衣功能</p>
            <button
      ...
      <main className="max-w-4xl mx-auto px-4 py-8 sm:py-12">
        ...
        {!emailVerified && (
          <div className="mb-6 p-4 bg-amber-50 border border-amber-200 rounded-xl">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-sm font-medium text-amber-800">试穿前请先验证邮箱</span>
            </div>
            <button
              onClick={() => router.push('/profile/account?login=true')}
        ...
        {isLoading && (
          <div className="mt-8 flex flex-col items-center gap-4">
            ...
            <p className="text-sm font-medium text-slate-600">AI 正在生成您的试穿效果...</p>
          ...
          {resultUrl && (
            <div className="bg-white rounded-2xl border border-slate-200 p-6">
              <div className="flex items-center justify-between mb-4">
                <h3 className="font-bold text-lg text-slate-900">试穿结果</h3>
        ...
        <div className="mt-12 pt-6 border-t border-slate-200 space-y-1.5">
          <p className="text-xs text-slate-400 text-center">
            上传图片即表示您同意 <a href="/terms" className="text-indigo-500 hover:text-indigo-600 underline">服务条款</a>
          </p>
          <p className="text-xs text-slate-400 text-center">
            虚拟试衣由 Kling AI 提供技术支持
          </p>
        </div>
      ...
      {showCreditsModal && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/40 backdrop-blur-sm">
          <div className="bg-white rounded-2xl shadow-2xl p-6 sm:p-8 max-w-sm mx-4 text-center">
            ...
            <p className="text-sm text-slate-500 mb-6">您当前的积分余额为0。试穿前请先购买积分包。</p>

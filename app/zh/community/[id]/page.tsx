      ...
      {deleteConfirm && (
        <div className="fixed inset-0 z-[70] flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-2xl p-6 max-w-sm w-full shadow-2xl">
            ...
            <p className="text-sm text-slate-500 mb-6">删除后无法恢复，确定要删除这条分享吗？</p>
            <div className="flex gap-2">
              <button
      ...
      {reportModal && (
        <div className="fixed inset-0 z-[70] flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-2xl p-6 max-w-sm w-full shadow-2xl">
            ...
            <p className="text-sm text-slate-500 mb-4 line-clamp-2">&ldquo;{reportModal.commentContent}&rdquo;</p>

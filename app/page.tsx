      ...
      <div className="min-h-screen bg-gradient-to-b from-pink-50 to-pink-100 flex flex-col overflow-x-hidden">
        ...
        <nav className="flex items-center justify-between px-4 sm:px-6 py-3 sm:py-4">
          <div className="flex items-center gap-2">
            {/* Logo 图标 - 响应式大小 */}
            <div className="w-7 h-7 sm:w-8 sm:h-8 bg-white rounded-lg shadow-md shadow-pink-200/50 flex items-center justify-center flex-shrink-0">
              <svg className="w-4 h-4 sm:w-5 sm:h-5 text-red-500" viewBox="0 0 24 24" fill="currentColor">
                <text x="12" y="17" fontSize="14" textAnchor="middle">美</text>
              </svg>
            </div>
            {/* Logo 文字 - 响应式大小 */}
            <span className="font-bold text-slate-900 text-base sm:text-lg">what to wear</span>
          </div>
        </nav>
        ...
        <main className="flex-1 flex flex-col items-center justify-center px-4 sm:px-6 -mt-8 sm:-mt-12">
          ...
          {/* 标题 - 响应式大小 */}
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-black text-center tracking-wide px-4">
            what to wear
          </h1>
          
          {/* 副标题 - 响应式 */}
          <p className="mt-2 sm:mt-3 text-sm sm:text-base text-gray-400 text-center px-4">
            By AI
          </p>
